...
[code-task title="Print Hello Python" taskId="24-00-pp-01" executionType="tests-execution" executionStrategy="python-code"]
...
[code-task title="Calculate and Print 5 * 5" taskId="24-00-pp-02" executionType="tests-execution" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Name and Expression" taskId="24-00-pp-03" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Calculations" taskId="24-00-pp-04" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Square of 7 * 7 Stars" taskId="24-00-pp-05" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
